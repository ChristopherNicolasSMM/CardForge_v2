...
collections/<coleção>/
  ...
  assets/icons_png/        ← símbolos/ícones customizados dessa coleção
                              (opcional — ver Símbolos de mana)
...
- **Fontes, imagens da biblioteca e ícones/símbolos customizados** — geralmente sim, pelo mesmo motivo.
